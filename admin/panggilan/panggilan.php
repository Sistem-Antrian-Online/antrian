            ...
            <div class="col-6">
                <div class="container-panggil-antrian shadow p-3 mb-5 rounded">
                    ...
                    <div class="button-panggilan">
                        ...
                        <div class="button-panggilan2"></div>
...
<script>
    ...
    */
    ...
    function panggil() {
        ...
        setTimeout(() => {audio_huruf.play()}, 10000);        
        setTimeout(() => {audio_1.play()}, 11000);
        setTimeout(() => {audio_2.play()}, 11900);
        setTimeout(() => {audio_3.play()}, 12900);
        setTimeout(() => {audio_tujuan.play()}, 13500);        
        setTimeout(() => {audio_loket.play()}, 15500);
