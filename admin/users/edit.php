                        ...
                        <table cellpadding="8" class="w-100">
                            ...
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="username" required
                                        value="<?= $row['username'] ?>" onkeypress="InputWord(event)" required></td>
                            </tr>
                            <tr>
                                <td>Password</td>
                                <td><input class="form-control" type="password" name="password" required
                                        value="<?= $row['password'] ?>" required></td>
                            </tr>
                            <tr>
                                <td>Level User</td>
                                <td>
                                    <select class="form-control" name="level_users" id="level_users" required
                                        value="<?= $row['level_users'] ?>">
