                        ...
                        <table cellpadding="8" class="w-100">
                            <tr>
                                ...
                                <td><input class="form-control" type="text" name="nama" required
                                        value="<?= $row['nama'] ?>" onkeypress="InputWord(event)" required></td>
                            </tr>
                            <tr>
                                <td>Deskripsi</td>
                                <td colspan="3"><textarea class="form-control" name="deskripsi" id="deskripsi"
                                        onkeypress="InputWord(event)" required><?= $row['deskripsi'] ?></textarea></td>
                            </tr>
                            <tr>
                                <td>Loket</td>
                                <td><input class="form-control" type="text" name="loket" required
                                        value="<?= $row['loket'] ?>" onkeypress="InputWord(event)" required></td>
                            </tr>
                            <tr>
                                <td>ID Dokter</td>
                                <td>
