        ...
        <div class="row row-cols-1 row-cols-md-4 g-2">
            ...
            ?>
                <div class="col text-center">
                    <div class="card text-bg-success mb-3 " style="width: 275px;height: 200px; cursor: pointer;" data-idpoli="<?= $idpoli; ?>" data-loket="<?= $huruf; ?>" data-nama="<?= $nama; ?>" data-antrian="<?= $no_antrianpoli; ?>" id="card-poli" onclick="update(this)">
...
<script>
    ...
    function update(el) {
        ...
        if (date_check.getHours() >= "7" && date_check.getHours() <= "14") {
